...
def press_button(n, lights = 50):
	...
	light = 1
	 ...
	 # Light is correct but starting from beggining of the array makes it change lights it shouldn't


	while light != n +1:
		lightsarray[light-1::light] = [not y for y in lightsarray[light-1::light]]
#		print(light)
		light +=1
